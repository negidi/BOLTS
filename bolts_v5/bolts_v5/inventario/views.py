...
def registrarHerramienta(request):
    ...
    x = activo.objects.create(id_activo = id_htas , nombre_activo = nombre_htas , cantidad = cantidad_htas , precio = precio_htas)
    herramientas.objects.create(cod_herramienta = codigo_htas,proveedor = proveedor_htas, marca = marca_htas, activo = x)
