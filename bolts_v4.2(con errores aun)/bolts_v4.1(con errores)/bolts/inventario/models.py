...
class herramientas(models.Model):
    cod_herramienta = models.CharField(primary_key = True, max_length=32)
    proveedor = models.CharField(max_length=70)
    marca = models.CharField(max_length=100)
    activoh = models.ForeignKey(activo, related_name="herramientas", blank=True, null=True, on_delete=models.CASCADE)

class maquinaria(models.Model):
    cod_maquinaria = models.CharField(primary_key = True, max_length=32)
    diseño_maquinaria = models.FileField(max_length=70)
    material_estructura = models.CharField(max_length=200)
    activom = models.ForeignKey(activo, related_name="maquinaria", blank=True, null=True, on_delete=models.CASCADE)
...
class clientes(models.Model):
    ...
    maquinariac = models.ForeignKey(maquinaria, related_name="clientes", blank=True, null=True, on_delete=models.CASCADE)
